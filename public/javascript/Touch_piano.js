const C4 = new Audio("sounds/piano/C1.mp3");
const Db4 = new Audio("sounds/piano/Cs1.mp3");
const D4 = new Audio("sounds/piano/D4.mp3");
const Eb4 = new Audio("sounds/piano/Ds4.mp3");
const E4 = new Audio("sounds/piano/E4.mp3");
const F4 = new Audio("sounds/piano/F4.mp3");
const Gb4 = new Audio("sounds/piano/Fs4.mp3");
const G4 = new Audio("sounds/piano/G4.mp3");
const Ab4 = new Audio("sounds/piano/Gs4.mp3");
const A4 = new Audio("sounds/piano/A4.mp3");
const Bb4 = new Audio("sounds/piano/As4.mp3");
const B4 = new Audio("sounds/piano/B4.mp3");
const C5 = new Audio("sounds/piano/C5.mp3");
const Db5 = new Audio("sounds/piano/Cs5.mp3");
const D5 = new Audio("sounds/piano/D5.mp3");
const Eb5 = new Audio("sounds/piano/Ds5.mp3");
